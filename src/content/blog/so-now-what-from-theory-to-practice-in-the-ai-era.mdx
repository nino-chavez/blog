...
This is critical: There are two completely different types of AI spending happening right now.
...
Your hedge: Make sure you're in the second category, not the first.

Are you delivering real ROI right now? Or are you promising returns in a future that depends on the bubble staying inflated?
