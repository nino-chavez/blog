...
I'll use [brand-forge](https://github.com/nino-chavez/brand-forge) — a CLI that manages brand design systems through a single JSON schema — as the running example. But the pattern works for any CLI tool. If your tool has commands, options, and context that an agent needs before it can act, this applies.
