...
[An earlier post](/blog/the-walk-in-is-full) argued that cost was a reflex, not a virtue — that the consensus machinery we treat as culture was actually a continuous, involuntary response to the expense of building. Here's a historical parallel I want to add to that argument.
