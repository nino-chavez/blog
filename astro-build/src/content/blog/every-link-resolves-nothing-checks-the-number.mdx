...
It doesn't check the number. It checks that a derivation was *declared*, and only in one narrow shape. A wrong figure with an honest, wrong formula beside it clears everything. What changed is that one specific silent failure — a breakdown of a set you've admitted you can't fully classify — now has to state its method or stop.
</Callout>
