...
Google's [Universal Commerce Protocol updates](https://blog.google/products-and-platforms/products/shopping/ucp-updates/) dropped today — new cart capabilities, simplified merchant onboarding, and a clearer path toward standardized agentic transactions. The headline framing is about AI shopping getting simpler. The structural implication runs deeper.

UCP wasn't built in a vacuum. It was [co-developed with Shopify](https://shopify.engineering/UCP) and supported by Etsy, Wayfair, Target, and Walmart, with over twenty endorsers including Visa, Mastercard, Stripe, and American Express. It's open-source under Apache 2.0. And it's [already live](https://www.pymnts.com/artificial-intelligence-2/2026/google-launches-agentic-commerce-with-etsy-and-wayfair/) — Etsy and Wayfair are processing agentic checkout through Google's AI Mode and Gemini right now.
