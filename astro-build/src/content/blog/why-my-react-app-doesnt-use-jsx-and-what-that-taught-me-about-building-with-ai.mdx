...
author: "Nino Chavez"
excerpt: "Most React apps are JSX-first. Mine isn't. That wasn't a bold opinion—it's just where I ended up after building a real system using AI as my primary coding partner."
