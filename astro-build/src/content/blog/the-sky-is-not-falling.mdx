...
And yet—I spent nearly **8+ hours** just trying to get the **section wave dividers** to look right.
...
![Timeline comparing the time spent building the site with the time spent polishing its wave dividers](/content/images/2025/06/letspepper_timeline_updated.png)

*The time cost of polishing one visual detail—the waves—overshadowed every other step.*
