...
The tracking-number rule is easy to turn into a check—a script could verify it in seconds, and probably should. But the most important rule I have is harder: [trust the codebase over the AI's plan](/blog/the-gate-verifies-the-work-not-the-plan). When the generated design contradicts the actual code, the code wins.
