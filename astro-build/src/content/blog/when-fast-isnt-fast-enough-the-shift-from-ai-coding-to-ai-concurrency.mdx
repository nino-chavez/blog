...
author: "Nino Chavez"
excerpt: "There'
featureImage: "/images/generated/when-fast-isnt-fast-enough-the-shift-from-ai-coding-to-ai-concurrency.webp"s a strange kind of bottleneck that only shows up after you've gotten fast. The only real blocker left is waiting for a model to finish one thing before starting the next."
