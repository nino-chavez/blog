...
author: "Nino Chavez"
excerpt: "There's a strange kind of bottleneck that only shows up after you've gotten fast. The only real blocker left is waiting for a model to finish one thing before starting the next."
