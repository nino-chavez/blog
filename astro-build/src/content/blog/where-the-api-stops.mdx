...
(If you want the working version of that negotiation rather than the reflection on it, I wrote up [the multi-account setup step by step](/blog/multi-account-instagram-publishing-graph-api) — the auth-path trap, the manual gates, and the publish call that quietly double-posts.)
