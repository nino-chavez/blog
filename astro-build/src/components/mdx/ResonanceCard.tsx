...
export function ResonanceCard({
  ...
  return (
    <a
      ...
      className="group block my-8 rounded-xl border border-zinc-700/50 bg-zinc-800/50 p-6 no-underline transition-all hover:border-signal-coral/40 hover:bg-zinc-800"
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          {/* Label */}
          <div className="flex items-center gap-2 mb-2">
            <span className="font-mono text-[0.625rem] uppercase tracking-[0.1em] text-signal-coral">
              Resonance
            </span>
            {agentReady && (
              <span className="font-mono text-[0.625rem] uppercase tracking-[0.1em] text-signal-coral">
          ...
          {/* Title */}
          <h4 className="text-lg font-semibold text-zinc-100 group-hover:text-signal-coral transition-colors m-0">
            {title}
          </h4>
        ...
        {/* Arrow */}
        <div className="flex-shrink-0 mt-1 text-zinc-600 group-hover:text-signal-coral transition-colors">
      ...
      <div className="mt-4 pt-4 border-t border-zinc-700/50">
        <span className="text-sm text-zinc-500 group-hover:text-signal-coral transition-colors">
