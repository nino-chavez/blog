...
Per [[01-research.md]] D5, v2's voice register starts from the v1 voice guide (`docs/signal-dispatch-voice-guide.md`, v1.1, 913 lines distilled from 156 posts) and documents its delta. Restart-from-scratch is rejected here because (a) the hiring-evaluator persona checks for voice consistency across posts, and (b) the v1 voice has measured market signal — discarding it for a clean slate trades known signal for unknown.
