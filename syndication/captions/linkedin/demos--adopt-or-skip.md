...
The uncomfortable part is what the exercise did in the other direction. Writing down my own baseline meant listing what loads at startup. Every hook. Every rule. Every helper. That list had grown entirely by accretion. A hook added during one bad afternoon. A rule added after one bad review. Skills installed once and never invoked since. All of it still loading, every session. Nothing ever prompts you to take something out.
